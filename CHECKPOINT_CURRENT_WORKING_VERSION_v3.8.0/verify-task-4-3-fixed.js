// Fixed verification script for Task 4.3: Enhanced Findings, Rationale, and Risk Factors Display
const fs = require('fs');
...
const hasKeyInsightHighlighting = jsContent.includes('key-insight') &&
                                 jsContent.includes('significant') &&
...
const hasSeverityDisplay = jsContent.includes('risk-severity') &&
                          jsContent.includes('HIGH') &&
                          jsContent.includes('MEDIUM') &&
                          jsContent.includes('LOW');
